...
<div class="eh-content">
  ...
  <div class="eh-card p-3">
    <div class="d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Haberler</h5>
      <a href="haber-ekle.php" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i>Yeni</a>
    </div>
    <div class="row g-2 mt-2">
      <div class="col-12 col-md-3"><input class="form-control form-control-sm" placeholder="Başlık ara"></div>
    ...
    <div class="table-responsive mt-3">
      <table class="table align-middle">
        <thead><tr><th>#</th><th>Başlık</th><th>Kategori</th><th>Durum</th><th>Tarih</th><th class="text-end">İşlem</th></tr></thead>
        <tbody>
          <tr>
            <td>1</td><td>Kütüphane 00:00'a kadar açık</td><td>Kampüs</td>
            <td><span class="eh-badge text-bg-success">Yayında</span></td><td>2025-10-25</td>
            <td class="text-end"><a class="btn btn-sm btn-outline-primary" href="haber-ekle.php"><i class="bi bi-pencil"></i></a></td>
          </tr>
          <tr>
            <td>2</td><td>Kantin menüsünde ufak değişiklik</td><td>Genel</td>
            <td><span class="eh-badge text-bg-warning">Taslak</span></td><td>2025-10-24</td>
            <td class="text-end"><a class="btn btn-sm btn-outline-primary" href="haber-ekle.php"><i class="bi bi-pencil"></i></a></td>
          </tr>
          <tr>
            <td>3</td><td>Teknoloji etkinliği yaklaşıyor</td><td>Teknoloji</td>
            <td><span class="eh-badge text-bg-success">Yayında</span></td><td>2025-10-23</td>
            <td class="text-end"><a class="btn btn-sm btn-outline-primary" href="haber-ekle.php"><i class="bi bi-pencil"></i></a></td>
          </tr>
        </tbody>
      </table>
