...
<div class="eh-content">
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-7">
      <div class="eh-card p-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <button class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i>Yeni</button>
        </div>
        <div class="table-responsive mt-3">
          <table class="table align-middle">
            <thead><tr><th>#</th><th>Ad</th><th class="text-end">İşlem</th></tr></thead>
            <tbody>
              <tr><td>1</td><td>Genel</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Düzenle</button></td></tr>
              <tr><td>2</td><td>Kampüs</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Düzenle</button></td></tr>
              <tr><td>3</td><td>Teknoloji</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Düzenle</button></td></tr>
            </tbody>
          </table>
        </div>
      </div>
    ...
    <div class="col-12 col-lg-5">
      <div class="eh-card p-3">
        <h6>Hızlı İpucu</h6>
        <p class="small text-secondary mb-0">Gerçekte burada ekle/düzenle işlemleri yapılacak. Bu sürüm sadece görünüm.</p>
      </div>
    </div>
  </div>
  </div>
