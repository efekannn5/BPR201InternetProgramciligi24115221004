...
<div class="eh-content">
  ...
  <div class="eh-card p-3">
    <div class="d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Editörler</h5>
      <button class="btn btn-sm btn-primary"><i class="bi bi-person-plus me-1"></i>Yeni</button>
    </div>
    <div class="table-responsive mt-3">
      <table class="table align-middle">
        <thead><tr><th>#</th><th>Ad Soyad</th><th>E-posta</th><th>Rol</th><th class="text-end">İşlem</th></tr></thead>
        <tbody>
          <tr><td>1</td><td>Efekan Nefesoğlu</td><td>efekan.nefesoglu@partner.magna.com</td><td>Admin</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Düzenle</button></td></tr>

          <tr><td>3</td><td>xxxxxxx</td><td>xxxxxx@site.com</td><td>Editör</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Düzenle</button></td></tr>
        </tbody>
      </table>
    </div>
  </div>
